<div class="d-flex" id="wrapper">
  ...
  <div style="background: #666699; color: #333;" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
      <a href="principal.php" class="list-group-item list-group-item-action" style="background: #666699; color: #ccc;"><span class="icon-home-1"></span> Dashboard</a>
